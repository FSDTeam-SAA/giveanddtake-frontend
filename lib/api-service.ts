...
export async function uploadElevatorPitch({
  ...
  const response = await apiClient.post(`/elevator-pitch/video?userId=${userId}`, formData, {
    headers: {
      "Content-Type": "multipart/form-data",
    },
  })
...
export async function getElevatorPitchVideo(userId: string) {
  const response = await apiClient.get(`/elevator-pitch/video?userId=${userId}`)
  return response.data
}
...
export async function updateElevatorPitchVideo({
  ...
  const response = await apiClient.put(`/elevator-pitch/video?userId=${userId}`, formData, {
    headers: {
      "Content-Type": "multipart/form-data",
    },
  })
...
export async function deleteElevatorPitchVideo(userId: string) {
  const response = await apiClient.delete(`/elevator-pitch/video?userId=${userId}`)
  return response.data
}
