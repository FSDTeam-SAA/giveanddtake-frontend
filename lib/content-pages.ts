 ...
 * "cards", which are not standalone pages) out of the More menu, footer and
 * sitemap dynamic listings.
 */
...
/** Built-in pages have dedicated routes; everything else lives under /pages/:slug. */
export const BUILT_IN_ROUTES: Record<string, string> = {
  about: "/about-us",
