...
export function MessageSidebar({ selectedRoomId, roomName, onRoomSelect, userId, userRole }: MessageSidebarProps) {
    ...
    const filteredRooms = rooms?.filter((room: MessageRoom) => {
                        ...
                        >
                            <div className="relative">
                                <Avatar className="w-12 h-12">
                                    <AvatarImage src={`/placeholder.svg?height=48&width=48&text=${otherUser.name.charAt(0)}`} />
