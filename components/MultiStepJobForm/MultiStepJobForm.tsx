...
//     compensation: '',
//     expirationDate: '',
//     jobDescription: `Your Mission
// Drive organic growth and boost online visibility for [Company Name] by developing cutting-edge SEO strategies that dominate search rankings and convert traffic into customers.

// Key Responsibilities
// * Keyword Strategy: Research high-impact keywords for content, products, and campaigns.
// * On-Page Optimization: Optimize website content, meta tags, headers, and URLs.
// * Technical SEO: Audit site health (speed, mobile-friendliness, indexing) using tools like Screaming Frog/Ahrefs.
// * Content Collaboration: Partner with content teams to create SEO-optimized blogs, guides, and landing pages.
// * Backlink Building: Develop ethical link-building strategies to boost domain authority.
// * Data-Driven Reporting: Track KPIs (traffic, rankings, conversions) via Google Analytics/Search Console.
// * Stay Ahead: Monitor algorithm updates (Google Core Updates) and industry trends.

// What We're Looking For
// Must-Have
// * 2+ years hands-on SEO experience
// * Proven success growing organic traffic & rankings
// * Proficiency in SEO tools (Ahrefs, SEMrush, Moz)
// * Strong analytics skills (GA4, Looker Studio)
// * Technical SEO knowledge (schema, XML sitemaps)
// * Excellent communication skills

// Nice-to-Have
// * Experience with e-commerce/SaaS SEO
// * Basic HTML/CSS understanding
// * Local SEO or international SEO expertise
// * Content marketing background

// Why Join Us?
// * Competitive salary + [bonus/equity options]
// * Flexible PTO + [remote work/wellness stipends]
// * Grow your skills with [training/conference budgets]
// * Collaborative team passionate about data-driven results
// * [Add another unique perk]

// How to Apply
// Submit your resume and 1-minute elevator pitch video (share via link) showing:
// 1. Your biggest SEO win
// 2. Why you're excited about this role

// Video tip: 60 seconds free—or go premium for 3 minutes!

// Apply by: [Date]
// Contact: [Email/Link to Application Portal]`,
//   });
...
//   const handleNext = () => {
//     if (currentStep === 1) {
//       if (!formData.jobTitle || !formData.country || !formData.region || !formData.employmentType || !formData.experience || !formData.category) {
...
//     toast.success('Job published successfully! Check console for form data.');
//   };
...
Contact: [Email/Link to Application Portal]`,
  ...
  const handlePublish = () => {
    ...
    const postData = {
      ...
      deadline: publishNow ? new Date().toISOString() : selectedDate?.toISOString() || '2025-08-31T00:00:00.000Z',
      status: 'active',
      jobCategoryId: '64f21f5cb45a3a001e899fa9',
