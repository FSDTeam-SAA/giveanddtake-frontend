  ...
  return (
    <Card className="flex flex-col sm:flex-row items-start sm:items-center p-4 sm:p-6 shadow-sm hover:shadow-md transition-shadow rounded-xl !border-none w-full">
      <Image
        src={
          companyLogo ||
          "/placeholder.svg?height=48&width=48&query=blue swirl logo"
        }
        alt="Company Logo"
        width={100}
        height={100}
      ...
      <div className="flex-1 grid gap-2 w-full">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <h3 className="text-base sm:text-lg md:text-[18px] font-semibold text-[#595959]">
            {jobTitle}
          </h3>
        ...
        <p className="text-[#707070] text-xs sm:text-sm font-normal line-clamp-2 text-left ">
          {description}
        </p>
