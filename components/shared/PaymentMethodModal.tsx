  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-[425px] p-6">
        <DialogHeader>
          <DialogTitle className="text-2xl font-bold text-[#000000]">Select Payment Method</DialogTitle>
          ...
          >
            <div className="flex items-center justify-between rounded-md border p-4 hover:bg-gray-50 transition-colors">
              <div className="flex items-center gap-3">
                <Image src="/assets/modal.png" alt="PayPal" width={30} height={30} className="h-[67px] w-[120px]" />
             
              </div>
              <RadioGroupItem className="border-[#2B7FD0]" value="paypal" id="paypal" />
            </div>
          </RadioGroup>
        </div>
