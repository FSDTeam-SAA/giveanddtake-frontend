  ...
  const form = useForm<ResumeFormData>({
    ...
    defaultValues: {
      ...
      sLink: (() => {
        ...
        if (
          Array.isArray(resume.resume?.sLink) &&
                        ...
                        <FormItem>
                          ...
                          <FormControl>
                            ...
                            >
                              ...
                              <SelectContent>
                                {experienceCitiesQueries[index]?.data?.map(
                                  (city) => (
                                    <SelectItem key={city} value={city}>
                                      {city}
                                    </SelectItem>
                        ...
                        <FormItem>
                          ...
                          <FormControl>
                            ...
                            >
                              ...
                              <SelectContent>
                                {educationCitiesQueries[index]?.data?.map(
                                  (city) => (
                                    <SelectItem key={city} value={city}>
                                      {city}
                                    </SelectItem>
