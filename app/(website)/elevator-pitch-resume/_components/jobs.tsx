...
export default function CreatedJobs() {
    ...
    const { data: recruitersJobs, isPending, isError, error } = useQuery({
    ...
    return (
        <div className="lg:space-y-10 space-y-5">
            <h2 className='text-[#4D4D4D] lg:text-3xl text-xl font-bold'>Your Jobs</h2>
                    ...
                    <div key={job._id} className="bg-[#F8F8F8] lg:p-7 p-3 lg:space-y-5 space-y-2 rounded-md">
                        ...
                        <div className="flex justify-between items-center gap-2">
                            ...
                            <div className="flex items-center space-x-3    ">
                                ...
                                >
                                    {archiveJobMutation.isPending ? <div className="flex items-center gap-2"><Loader className="animate-spin" /> Archiving</div> : 'Archive'}
                                </Button>
                            </div>
                        </div>
                    </div>
