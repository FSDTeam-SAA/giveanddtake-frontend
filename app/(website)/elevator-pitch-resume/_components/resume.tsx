...
import { MapPin, Clock, GraduationCap, Briefcase, AwardIcon, SquarePen, Edit, Trash2, Download } from "lucide-react"
...
import { deleteElevatorPitchVideo, updateElevatorPitchVideo, uploadElevatorPitch } from "@/lib/api-service"
        ...
        <Card className="mb-8">
          <CardContent className="p-6">
            <div className="flex items-center justify-between mb-4">
              <div>
                <h2 className="text-2xl font-bold text-gray-800">Your Elevator Pitch</h2>
            ...
            {isEditingPitch ? (
              ...
              <div className="space-y-4">
                <div className="relative rounded-lg overflow-hidden">
                  <video controls className="w-full h-auto rounded-lg" poster="/placeholder.svg?height=400&width=600">
                    <source src={resume.elevatorPitch[0].video.url} type="video/mp4" />
              ...
              <div className="text-center py-12">
                <div className="mb-4">
                  ...
                  <h3 className="text-lg font-semibold text-gray-800 mb-2">No Elevator Pitch Yet</h3>
                  <p className="text-gray-600 text-sm mb-4">
                    Upload a video to showcase your skills and personality to potential employers.
                  </p>
                  <Button onClick={() => setIsEditingPitch(true)} className="bg-blue-600 hover:bg-blue-700">
                    Upload Video
                  </Button>
                </div>
              </div>
        ...
        <Card className="border-0">
          <CardContent className="p-0">
            <div className="mb-2 lg:mb-0 flex items-center justify-center relative">
              <h1 className="text-xl text-center sm:text-4xl font-bold text-gray-800">My Resume</h1>
              <div className="absolute right-0">
                <Button onClick={onEdit} className="bg-[#3b82f6] hover:bg-[#3b82f6]">
                  ...
                  <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4 text-sm">
                    ...
                    <div>
                      ...
                      <span className="text-blue-600">
                        {resume.resume.sLink?.find((link: any) => link.label === "website")?.url || "www.example.com"}
                      </span>
                    </div>
                  </div>
                </div>
            ...
            <section className="border-b-2 py-6 sm:py-10 lg:py-12 px-0 sm:px-6">
              ...
              <div className="space-y-6">
                {resume.education?.map((edu) => (
                  <div key={edu._id} className="flex flex-col sm:flex-row gap-4 items-start sm:items-center">
                    <div className="w-16 h-16 bg-blue-100 rounded-lg flex items-center justify-center flex-shrink-0">
