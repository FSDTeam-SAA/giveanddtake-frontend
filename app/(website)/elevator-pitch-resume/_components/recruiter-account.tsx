...
import { Building2, Circle, ExternalLink, Globe, Linkedin, MapPin, BriefcaseBusiness, Twitter } from 'lucide-react'
...
export default function RecruiterAccount({
    ...
    const websiteHref =
        companyLinks[0] || OtherLink || upworkUrl || undefined
        ...
        <div className="w-full bg-background">
            ...
            <div className="w-full">
                <div className="relative h-36 sm:h-44 md:h-56 lg:h-80 bg-muted">
                    <Image
                        src={"/placeholder.svg?height=256&width=1600&query=recruiter%20profile%20cover%20subtle%20gray"}
                        alt={"Cover image"}
                        fill
