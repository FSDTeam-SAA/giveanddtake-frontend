  ...
  return (
    <div className=" bg-white py-12 ">
      <div className=" container ">
       ...
       <PageHeaders title="About Us" description="Elevator Video Pitches was initially conceived in 2016 at a time of high employment amidst a ‘skills shortage’ which has" subdescription="Abated. Today, millions of knowledgeable, highly skilled and competent professionals, graduates, school leavers have tried unsuccessfully for years to find a job. We see you, we hear you, we care."/>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between mb-16 gap-y-5">
          <div className="flex-1 space-y-10 text-center md:text-left">
            <div>
              <h2 className="text-3xl md:text-[40px] font-bold text-[#131313] mb-3">Our Vision</h2>
            ...
            <div>
              <h2 className="text-3xl md:text-[40px] font-bold text-[#131313] mb-3">Our Mission</h2>
              <p className="text-base font-normal text-[#545454] leading-relaxed">
        ...
        <div className="text-center md:text-left">
          <div className="mb-10">
            <h2 className="text-3xl text-[38px] font-bold text-[#131313] mb-3">What We Offer</h2>
          ...
          <div>
            <h2 className="text-3xl text-[38px] font-bold text-[#131313] mb-4">Unique Business content</h2>
