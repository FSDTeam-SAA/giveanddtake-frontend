      ...
      <div className="container space-y-8">
        ...
        <div className="space-y-4">
          ...
          <ul className="list-disc space-y-2 pl-6 text-gray-700 dark:text-gray-300">
            <li>
              ...
              you could delete your account in the portal and final deletion
              would take place automatically after 30 days. If you log back into
              your account before the 30 days expiration date, your profile will
              remain active thereafter and will not be deleted until you choose
              to delete this again.
            </li>
            <li>
              You could also send an email to info@evpitch.com or via our
              contact form to request the deletion of your data. Some clients
              may prefer to write to us to exercise their rights as a data
              subject. Our correspondence address is 124 City Road. London. EC1V
              2NX. Once a request to delete your data has been received,
              Elevator Video Pitch© recordings and resumes deletion would be
              completed within 30 days, and if this cannot be done, we will
              request an extension to do so within the GDPR mandated time
              limits.
            </li>
          </ul>
        </div>
        ...
        <div className="space-y-4">
          ...
          <p className="text-gray-700 dark:text-gray-300">
            ...
            please contact us by email at info@evpitch.com or through our
            contact form. Please ensure that your query is clear, particularly
            if it is a request for information about the data we hold about you.
          </p>
        </div>
        <div className="space-y-4">
