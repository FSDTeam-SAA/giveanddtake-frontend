      ...
      <div className="space-y-6 text-gray-700 dark:text-gray-300 text-sm leading-relaxed">
        ...
        <section>
          ...
          <ol className="list-decimal list-inside ml-4 space-y-1 text-[#424242] text-base font-normal">
            ...
            <li>
              You will keep your password a secret (as you would protect your
              bank pin number).
            </li>
            <li>
        ...
        <section>
          ...
          <p className="mb-2 text-[#424242] text-base font-normal">
            If you purchase a subscription, your payment method will be
            automatically charged at the start of each subscription period for
            the fees and taxes applicable to that period. To avoid future
            charges, please cancel before the renewal date.
          </p>
          <p className="mb-2 text-[#424242] text-base font-normal">
        ...
        <section>
          ...
          <p className="mb-2 text-[#424242] text-base font-normal">
            We will not include your CVs, Profiles or Elevator Video Pitches in
            advertisements, or sell your content to third parties.
          </p>
          <p className="mb-2 text-[#424242] text-base font-normal">
        ...
        <section>
          ...
          <p className="mb-2 text-[#424242] text-base font-normal">
            We use the data and other information that you provide and that we
        ...
        <section>
          ...
          <p className="mb-2 text-[#424242] text-base font-normal">
            ...
            caused by the breach and were foreseeable as a precursor to and upon
        ...
        <section>
          ...
          <p className="mb-2 text-[#424242] text-base font-normal">
            ...
            registered address provided on our website.
          </p>
        </section>
        ...
        <section>
          ...
          <ol className="list-decimal list-inside ml-4 space-y-1 text-[#424242] text-base font-normal">
            ...
            <li>
              Use your real name on your profile and in your elevator video
              pitch; and
            </li>
          ...
          <ol className="list-decimal list-inside ml-4 space-y-1 text-[#424242] text-base font-normal">
            ...
            <li>
              ...
              including profiles and other data from the Services.
            </li>
            <li>
              Override any security feature or bypass or circumvent any access
              controls or use limits of the Services (such as search results,
              profiles, or videos).
            </li>
            <li>
              Copy, use, display or distribute any information (including
              profiles) obtained from the Services, whether directly or through
            ...
            <li>
              ...
              attempt to derive the source code for the Site or any related
            ...
            <li>
              Re-sell or otherwise monetise our Services or related data or
              access to the same.
            </li>
            <li>
            ...
            <li>
              Violate any terms concerning a specific Service that is provided
